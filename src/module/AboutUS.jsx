        ...
        <div class="container text-center border border-success rounded p-3 mb-5"><p className='fs-2'>Who we Are?</p>
                <div class="row">
                    <div class="col fs-2 font-weight-bold">
                        ...
                        <div class="col">
                        <img src="https://ecoreco.com/Images/e-waste.jpg" class="img-thumbnail"  alt="/" />
                    </div>
                    </div>
                ...
                <div className='m-5'>
                    <img src='https://www.erdshoppe.com/wp-content/uploads/2021/08/Ideal-E-Waste-Scenario-by-ERD-Technologies-Global-India.jpg' height='400px' alt="."/>
